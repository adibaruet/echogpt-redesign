...
3. [Analysis of the current interface](#1-analysis-of-the-current-interface)
4. [What was built](#2-what-was-built)
5. [Architecture](#3-architecture)
6. [Accessibility](#4-accessibility-wcag-22-considerations)
7. [Performance](#5-performance)
8. [Assumptions](#6-assumptions)
9. [Possible next steps](#7-possible-next-steps)
...
| 9 | Theme switch is an unlabelled sun icon in a bottom bar. | Hard to discover. | Theme toggle in the header, a labelled segmented control in Settings, and a **System** mode. |
